...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-ring hover:bg-neutral-100 text-neutral-800 absolute top-1 right-1 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset"
    >
...
export function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-white text-neutral-900 relative max-w-sm rounded-xl border border-neutral-200 p-3 shadow-xl",
...
export function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-neutral-900 text-white pointer-events-none rounded-md px-2.5 py-1 text-xs shadow-md font-medium",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-neutral-900 text-[11px] font-semibold bg-white/90 backdrop-blur-xs px-1.5 py-0.5 rounded shadow-xs border border-neutral-200/80",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border border-neutral-200 bg-white [&>button:not(:last-child)]:border-neutral-200 flex flex-col overflow-hidden rounded-lg shadow-md [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-8 items-center justify-center transition-colors text-neutral-700",
        "first:rounded-t-lg last:rounded-b-lg",
        "hover:bg-neutral-100",
        "focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:outline-none focus-visible:ring-inset",
  ...
  return (
    <ControlButton onClick={onClick} label="Reset bearing to north">
      ...
      >
        ...
        <path d="M12 22L16 12H12V22Z" className="fill-neutral-400" />
        <path d="M12 22L8 12H12V22Z" className="fill-neutral-300" />
      </svg>
    </ControlButton>
  );
}
